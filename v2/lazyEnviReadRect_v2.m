function [ hsi_sub ] = lazyEnviReadRect_v2( datafile,hdr_info,crange,lrange,brange)
...
%       crange: range of columns [cstart,cend]
%       lrange: range of lines [lstart, lend]
%       brange: range of bands [bstart, bend]
%   Outputs:
