function [  ] = hsiview_v3p( rgb,GLTdata,hsiar,legends,varargin )
...
set(hdt,'UpdateFcn',{@map_cursor_crismx,rgb,GLTdata,ax_spc,hsiar,legends,keepHdl,...
...
function output_txt = map_cursor_crismx(obj,event_obj,CData,GLTdata,ax_spc,hsiar,legends,...
